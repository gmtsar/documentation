...
******************************
download_sentinel_orbits[_linux].csh
******************************

Synopsis
--------
**download_sentinel_orbits[_linux].csh** *safefilelist mode*

Description
-----------
**download_sentinel_orbits[_linux].csh** Downloads precise or restituted orbits for specific Sentinel-1 *.SAFE data files
...
Example
-------
**download_sentinel_orbits[_linux].csh** SAFEfile.list 1 
