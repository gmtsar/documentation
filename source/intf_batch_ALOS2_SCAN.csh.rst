...
Description
-----------
**intf_batch_ALOS2_SCAN.csh** make a stack of ALOS2 interferograms listed in intf.in
 ...
 batch.alos2.config is a config file for making interferograms


Note: config files can be created using :doc:`pop_config.csh`
